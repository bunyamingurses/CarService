                        ...
                        <div class="col-lg-12">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h1 text-gray-900 mb-4">Atlantis Oto Servis</h1>
                                    <h1 class="h4 text-gray-900 mb-4">HOŞGELDİNİZ</h1>
                                </div>
                                <form class="user" action="{{ route("login.loginPost") }}" method="post">
                                    @csrf
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user"
                                               id="Username" name="Username" aria-describedby="emailHelp"
                                               placeholder="Kullanıcıadı'nı Girin...">
                                    </div>
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-user"
                                               id="Password" name="Password" placeholder="Parola Girin...">
                                    </div><button type="submit" class="btn btn-primary btn-user btn-block">Giriş Yap <span class="fa fa-shield-alt"></span></button>
